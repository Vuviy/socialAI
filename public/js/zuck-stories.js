  ...
  stories: [
    ...
    Zuck.buildTimelineItem(
      ...
      [
        ...
        ["user1-story1", "photo", 5, "../public/img/01.jpg", "", '', false, false, timestamp()],
        ["user1-story2", "video", 0, "#", "", '', false, false, timestamp()],
        ["user1-story3", "photo", 5, "../public/img/02.jpg", "", 'https://webestica.com/', 'Visit my Portfolio', false, timestamp()]
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user2-story1", "photo", 5, "../public/img/03.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user3-story1", "photo", 5, "../public/img/04.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user4-story1", "photo", 5, "../public/img/05.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user5-story1", "photo", 5, "../public/img/06.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user6-story1", "photo", 5, "../public/img/06.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    {
      id: "user-7",               // story id
      photo: "../public/img/05.jpg",            // story photo (or user photo)
      ...
      items: [              // array of items
        // Story item
        {
          ...
          src: "../public/img/05.jpg",      // photo or video src
