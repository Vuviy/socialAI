                        ...
                        <div class="offcanvas-body p-0">
                            <div class="card card-chat-list rounded-end-lg-0 card-body border-end-lg-0 rounded-top-0">
                                ...
                                <div class="mt-4 h-100">
                                    <div class="chat-tab-list custom-scrollbar os-host os-theme-dark os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition"><div class="os-resize-observer-host observed"><div class="os-resize-observer" style="left: 0px; right: auto;"></div></div><div class="os-size-auto-observer observed" style="height: calc(100% + 1px); float: left;"><div class="os-resize-observer"></div></div><div class="os-content-glue" style="margin: 0px; width: 252px; height: 74px;"></div><div class="os-padding"><div class="os-viewport os-viewport-native-scrollbars-invisible os-viewport-native-scrollbars-overlaid" style="overflow-y: scroll;"><div class="os-content" style="padding: 0px; height: 100%; width: 100%;">
...
{{--                                                            <a href="#chat-1" class="nav-link text-start active" id="chat-1-tab" data-bs-toggle="pill" role="tab" aria-selected="true">--}}
{{--                                                            </a>--}}


                                                        @php

                                                            $chatWith = $chat->oponent->id === $user->id ? $chat->user : $chat->oponent;
                                                        ...
                                                        <li data-bs-dismiss="offcanvas">
                                                            <!-- Chat user tab item -->
                                                            <a href="#chat-{{$chat->id}}" class="nav-link text-start {{$chatWith->id == request('user') ? 'active' : ''}}" id="chat-1-tab" data-bs-toggle="pill" role="tab" aria-selected="{{$chatWith->id == request('user') ? 'true' : 'false'}}" tabindex="{{$chatWith->id == request('user') ? '' : '-1'}}-1">
                                                                <div class="d-flex">
                                                                    <div class="flex-shrink-0 avatar avatar-story me-2 status-online">
                                                                        <img class="avatar-img rounded-circle" src="{{asset('storage/'.$chatWith->profile->photo)}}" alt="">
                                                                    </div>
                                                                    <div class="flex-grow-1 d-block">
                                                                        <h6 class="mb-0 mt-1">{{$chatWith->name}}</h6>
...
{{--                                                        </li>--}}
                                                ...
                                                </div></div></div><div class="os-scrollbar os-scrollbar-horizontal os-scrollbar-unusable os-scrollbar-auto-hidden"><div class="os-scrollbar-track os-scrollbar-track-off"><div class="os-scrollbar-handle" style="width: 100%; transform: translate(0px, 0px);"></div></div></div><div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden"><div class="os-scrollbar-track os-scrollbar-track-off"><div class="os-scrollbar-handle" style="height: 15.3061%; transform: translate(0px, 1.58072px);"></div></div></div><div class="os-scrollbar-corner"></div></div>
                                </div>
                                <!-- Chat list tab END -->
                            </div>
                        </div>
                ...
                <div class="card card-chat rounded-start-lg-0 border-start-lg-0">
                    <div class="card-body h-100">
                        ...
                        {{--    AAAAAAAAAAAAAAAAAAAAA        --}}
                            ...
                            <div class="fade tab-pane h-100 {{$chatWith->id == request('user') ? 'active show' : ''}}" id="chat-{{$chat->id}}" role="tabpanel" aria-labelledby="chat-{{$chat->id}}-tab">
                                ...
                                <hr>
                                <!-- Chat conversation START -->
                                <div class="chat-conversation-content custom-scrollbar os-host os-theme-dark os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition"><div class="os-resize-observer-host observed"><div class="os-resize-observer" style="left: 0px; right: auto;"></div></div><div class="os-size-auto-observer observed" style="height: calc(100% + 1px); float: left;"><div class="os-resize-observer"></div></div><div class="os-content-glue" style="margin: 0px;"></div><div class="os-padding"><div class="os-viewport os-viewport-native-scrollbars-invisible os-viewport-native-scrollbars-overlaid" style="overflow-y: scroll;"><div class="os-content" style="padding: 0px; height: 100%; width: 100%;">
                                                <!-- Chat time -->
...
{{--                                                            </div>--}}
                                                            <div class="flex-grow-1">
                                                                <div class="w-100">
                                                                    <div class="d-flex flex-column align-items-start">
                                                                        ...
                                                                        <div class="small my-2">{{\Carbon\Carbon::createFromTimeStamp(strtotime($message->created_at))->diffForHumans()}}</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <!-- Chat message right -->
                                                        <div class="d-flex justify-content-end text-end mb-1 message-right">
                                                                <div class="w-100">
                    ...
                    <div class="card-footer">
                        <div class="d-sm-flex align-items-end">
                            <textarea class="form-control mb-sm-0 mb-3" id="message-content" data-autoresize="" placeholder="Type a message" rows="1"></textarea>
...
{{--                            <button class="btn btn-sm btn-secondary-soft ms-2"><i class="fa-solid fa-paperclip fs-6"></i></button>--}}
                            <button class="btn btn-sm btn-primary ms-2 send-message">send</button>
                        </div>
                    </div>
                </div>
            </div>
