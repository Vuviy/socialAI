...
{{--    @dd()--}}
    ...
    <div class="container">
                        ...
                        <div class="offcanvas-body p-0">
                            <div class="card card-chat-list rounded-end-lg-0 card-body border-end-lg-0 rounded-top-0">
                                ...
                                <div class="mt-4 h-100">
                                    <div class="chat-tab-list custom-scrollbar os-host os-theme-dark os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition"><div class="os-resize-observer-host observed"><div class="os-resize-observer" style="left: 0px; right: auto;"></div></div><div class="os-size-auto-observer observed" style="height: calc(100% + 1px); float: left;"><div class="os-resize-observer"></div></div><div class="os-content-glue" style="margin: 0px; width: 252px; height: 88px;"></div><div class="os-padding"><div class="os-viewport os-viewport-native-scrollbars-invisible os-viewport-native-scrollbars-overlaid" style="overflow-y: scroll;"><div class="os-content" style="padding: 0px; height: 100%; width: 100%;">
                                                    <ul class="nav flex-column nav-pills nav-pills-soft" role="tablist">
                                                        <!-- Chat user tab item -->

                                                        @foreach($user->chats as $chat)
                                                        <li data-bs-dismiss="offcanvas">
                                                            <a href="#chat-{{$chat->id}}" class="nav-link text-start" id="chat-{{$chat->id}}-tab" data-bs-toggle="pill" role="tab" aria-selected="true">
                                                                <div class="d-flex">
                                        ...
                                        <div class="os-scrollbar os-scrollbar-horizontal os-scrollbar-unusable os-scrollbar-auto-hidden">
                                            ...
                                            </div></div><div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
                                            <div class="os-scrollbar-track os-scrollbar-track-off">
                                                <div class="os-scrollbar-handle" style="height: 18.1633%; transform: translate(0px, 0px);"></div>
                                            </div></div>
                    ...
                    {{--========================--}}
                        ...
                        @foreach($user->chats as $chat)
                            <div class="fade tab-pane h-100" id="chat-{{$chat->id}}" role="tabpanel" aria-labelledby="chat-{{$chat->id}}-tab">
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <div class="d-flex mb-2 mb-sm-0">
                                        ...
                                        <div class="d-block flex-grow-1">
                                            <h6 class="mb-0 mt-1">{{$chat->oponent->name}}</h6>
                                            <div class="small text-secondary"><i class="bi bi-circle-fill"></i>Online</div>
                                        </div>
                                    </div>
                                ...
                                <hr>
                                <!-- Chat conversation START -->
                                <div class="chat-conversation-content custom-scrollbar os-host os-theme-dark os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition"><div class="os-resize-observer-host observed"><div class="os-resize-observer" style="left: 0px; right: auto;"></div></div><div class="os-size-auto-observer observed" style="height: calc(100% + 1px); float: left;"><div class="os-resize-observer"></div></div><div class="os-content-glue" style="margin: 0px; width: 839px; height: 79px;"></div><div class="os-padding"><div class="os-viewport os-viewport-native-scrollbars-invisible os-viewport-native-scrollbars-overlaid" style="overflow-y: scroll;"><div class="os-content" style="padding: 0px; height: 100%; width: 100%;">
                                                <!-- Chat time -->
        ...
        {{--                                                    </div>--}}
                                            ...
                                            </div></div></div><div class="os-scrollbar os-scrollbar-horizontal os-scrollbar-unusable os-scrollbar-auto-hidden"><div class="os-scrollbar-track os-scrollbar-track-off"><div class="os-scrollbar-handle" style="width: 100%; transform: translate(0px, 0px);"></div></div></div><div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden"><div class="os-scrollbar-track os-scrollbar-track-off"><div class="os-scrollbar-handle" style="height: 7.83545%; transform: translate(0px, 27.1307px);"></div></div></div><div class="os-scrollbar-corner"></div></div>
                    ...
                    <div class="card-footer">
                        <div class="d-sm-flex align-items-end">
                            <textarea class="form-control mb-sm-0 mb-3 message" data-autoresize="" placeholder="Type a message" rows="1"></textarea>
